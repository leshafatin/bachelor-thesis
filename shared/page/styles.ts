...
export const cartRowStyle: React.CSSProperties = {
  display: "grid",
...
export const cartThumbStyle: React.CSSProperties = {
  width: 56,
  height: 56,
  objectFit: "cover",
  borderRadius: 10,
...
export const modalGridStyle: React.CSSProperties = {
  display: "grid",
...
export const modalImageWrapStyle: React.CSSProperties = {
  background: "#f8fafc",
  borderRadius: 18,
  overflow: "hidden",
};
